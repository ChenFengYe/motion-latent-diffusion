...
smpl2mmm_correspondence = {val: key for key, val in mmm2smpl_correspondence.items()}
smpl2mmm_indexes = [JOINT_MAP[mmm2smpl_correspondence[x]] for x in mmm_joints]

# cal mmm joints map
MMM_JOINT_MAP = {val: JOINT_MAP[val] for key, val in mmm2smpl_correspondence.items()}
...
# todo - configable
SMPL_MODEL_DIR = (
    "/apdcephfs/share_1227775/shingxchen/AIMotion/TMOSTData/deps/smpl_models/"
)
GMM_MODEL_DIR = (
    "/apdcephfs/share_1227775/shingxchen/AIMotion/TMOSTData/deps/smpl_models/"
)
